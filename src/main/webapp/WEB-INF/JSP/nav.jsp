<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <!-- Bootstrap Styles-->
    ...
    <link href='https://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' /> 
        ...
        <!--/. NAV TOP  -->
        <nav class="navbar-side" style="overflow:auto!important;">
		<div id="sideNav" href=""><i class="fa fa-caret-right"></i></div>
            <div class="sidebar-collapse" style="overflow:auto!important;min-height:1200px !important;">
                <ul class="nav" id="main-menu">

                    <li class="active-menu">
                        <a href="#"><i class="fa fa-dashboard"></i>人员管理</a>
                         <ul class="nav nav-second-level">
                                    <li class="active-menu">
                                         <a href="${pageContext.request.contextPath}/staff/into" >添加员工</a>
                                    </li>
                                    <li>
                                        <a href="${pageContext.request.contextPath}/user/into" >添加用户</a>
                                    </li>
                                    <li>
                                        <a href="${pageContext.request.contextPath}/user/urole">用户信息</a>
                                    </li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-fw fa-file"></i>new page</a>
                    </li>
                </ul>
